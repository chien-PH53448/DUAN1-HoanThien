                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" value="<?= $user['sdt'] ?>" name="sdt"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="address" name="diachi" rows="3"
                                    placeholder="Nhập địa chỉ giao hàng" required><?= $user['diachi'] ?> </textarea>
                            </div>
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-footer text-end fw-bold">
                        Tổng tiền: <span class="text-danger"><?= number_format($totalPriceOrder)?> VNĐ</span>
                    </div>
                </div>
            </div>
        </div>
